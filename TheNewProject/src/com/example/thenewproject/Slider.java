...
public class Slider extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button handle1 = (Button) findViewById(R.id.sbutton1);
		Button handle2 = (Button) findViewById(R.id.sbutton2);
		Button handle3 = (Button) findViewById(R.id.sbutton3);
		Button handle4 = (Button) findViewById(R.id.sbutton4);
		CheckBox checkbox = (CheckBox)findViewById(R.id.scheckBox);
